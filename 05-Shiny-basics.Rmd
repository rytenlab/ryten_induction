...
**Aim\:** This markdown aims to demonstrate how to utilise the AWS API to load data from an AWS bucket into the R environment. It then shows how to use this data in a Shiny web application.  

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

### 1. Install the `aws.s3` package  
...
### 2. Getting your unique AWS access keys - refer to Sonia for help with this step  
...
### 3. Setting up your `.Renviron` file  
...
### 5. Loading data from AWS in a Shiny `app.R` file  

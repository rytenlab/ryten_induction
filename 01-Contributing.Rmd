...
1. Install the `bookdown` R package. 
...
1. Add a package to the code chunk in `index.Rmd` labeled "r_package_references". Then, refer it in the text via `[@R-package_name]`. 
